...
13. Classic lifecycle hooks vs modern lifecycle APIs
...
Open [`/queries-and-projection`](http://localhost:4200/queries-and-projection).
...
Open [`/view-encapsulation`](http://localhost:4200/view-encapsulation). Three
...
Open [`/change-detection`](http://localhost:4200/change-detection). The page
...
Open [`/component-lifecycle`](http://localhost:4200/component-lifecycle). Two
